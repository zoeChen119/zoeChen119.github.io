...
② ColPeli 能够生成类似 ColBERT（Khattab 和 Zaharia, 2020）风格的多向量表示。ColBERT 是一种用于信息检索的方法，它不是简单地将整个文档编码成单个向量，而是为文档中的每个词或短语生成独立的向量表示。这种方法有助于提高检索精度，因为它可以捕捉查询与文档之间的细粒度匹配。
